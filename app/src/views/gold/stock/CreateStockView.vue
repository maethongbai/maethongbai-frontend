...
<div v-if='user.role == "employee" ||
    ...
    <form @submit.prevent="createGold()">
        <div class="mx-3 my-3">
            ...
            <div class="mx-3 my-3">
            <label class="mx-3">รูปสินค้า</label>
