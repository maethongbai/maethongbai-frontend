    ...
    <div>
            ...
            <div>
                ...
                <div v-if="onlineSale.gold.gold_type != null">
                    <p class="font-normal text-gray-700 inline" v-if=" onlineSale.gold.gold_type.name != 'แหวน'"> เซนติเมตร </p>
                </div>
                <p class="mx-3 my-3 font-normal text-gray-700"> ราคา: {{ gold_price }} </p>
                <button type="submit" class="p-2 mx-3 my-3 bg-green-400 border rounded-lg"> ดำเนินการขั้นตอนต่อไป</button>
            </div>
        </div>
        </div>
    </div>
...
export default {
    ...
    async createOnlineSale() {
            ...
            var onlineSale = {
                ...
                gold_price: this.onlineSale.gold_price,
                paid_amount: 0,
                paid_change: 0,
